/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc workers/worker-configuration.d.ts` (hash: f1a9e43d5e591e5d9fd6595d828644ea)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "METAGRAPH_CONTRACT_VERSION" | "METAGRAPH_ENABLE_RPC_PROXY" | "METAGRAPH_R2_LATEST_PREFIX" | "METAGRAPH_ENABLE_AI" | "METAGRAPH_BLOCKS_SOURCE" | "METAGRAPH_EXTRINSICS_SOURCE" | "METAGRAPH_ACCOUNT_EVENTS_SOURCE" | "METAGRAPH_NEURONS_SOURCE" | "METAGRAPH_TOP_HOLDERS_SOURCE" | "METAGRAPH_SUBNET_HYPERPARAMS_SOURCE" | "METAGRAPH_ACCOUNT_IDENTITY_SOURCE" | "METAGRAPH_SUBNET_IDENTITY_SOURCE" | "METAGRAPH_RPC_USAGE_SOURCE" | "METAGRAPH_SUBNET_SNAPSHOTS_SOURCE" | "METAGRAPH_HEALTH_SOURCE" | "GITHUB_OAUTH_CLIENT_ID">> {}
}
